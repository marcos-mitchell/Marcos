...
import { Bell, Filter, Camera, AlertTriangle, Activity, RefreshCw, AlertCircle, Users, UserPlus, Settings } from "lucide-react";
...
// Mock de usuários
const initialUsers = [
  { id: 1, name: "Thomas Shelby", username: "Shelby", role: "Admin", email: "thomas@shelby.com", status: "active", lastLogin: "2025-09-19 14:30" },
  { id: 2, name: "Pedro Guambe", username: "Guambe", role: "Viewer", email: "pedro@guambe.com", status: "active", lastLogin: "2025-09-26 10:15" },
  { id: 3, name: "Ana Silva", username: "Ana", role: "Viewer", email: "ana@silva.com", status: "inactive", lastLogin: "2025-09-12 16:45" },
];
...
export default function Dashboard({ currentUser }) {
  ...
  // Dentro do componente Dashboard, depois dos outros useEffect
  useEffect(() => {
    if (activeCam) {
      const camAtiva = cameras.find(c => c.id === activeCam);
      if (camAtiva && !camAtiva.alert) {
        setActiveCam(null); // Fecha automaticamente o fullscreen
      }
    }
  }, [cameras, activeCam]);
  ...
  // Funções de gerenciamento de usuários (apenas para Admin)
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <div className="text-gray-400 mt-1">
            Sistema de monitoramento de Perímetro
          </div>
        </div>
        ...
        <div className="flex gap-2">
          ...
          {currentUser?.role === "Admin" && (
            ...
            >
              <Users size={20} />
              {showUsers ? "Voltar às Câmeras" : "Gerenciar Usuários"}
            </button>
          )}
      ...
      {/* Conteúdo principal - alterna entre câmeras e usuários */}
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gray-800 p-4 rounded-2xl shadow-lg flex flex-col items-center gap-2">
              ...
              <p className="text-3xl font-bold text-purple-400">{activeUsers}/{totalUsers}</p>
            </div>
          </div>
...
const UserManagement = ({ users, currentUser, onAddUser, onUpdateUser, onDeleteUser, onToggleUserStatus }) => {
  ...
  const handleAddUser = (e) => {
    e.preventDefault();
    onAddUser(newUser);
    setNewUser({ name: "", username: "", email: "", role: "Viewer", password: "" });
        ...
        {showAddForm && (
          ...
          >
            ...
            <form onSubmit={handleAddUser} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              />
              <div className="flex gap-2">
                <button type="submit" className="bg-green-600 px-4 py-2 rounded-lg hover:bg-green-700">
                  Adicionar
                </button>
                <button 
                  type="button" 
          ...
          <table className="w-full">
            <thead className="bg-gray-700">
              <tr>
                ...
                <th className="p-4 text-left">Último Login</th>
      ...
      <AnimatePresence>
        {editingUser && (
          ...
          >
            ...
            >
              <h3 className="text-xl font-bold mb-4">Editar Utilizador</h3>
...
// Componente CameraCard (mantido igual)
...
// Componente Zoom para Câmera Simulada (mantido igual)
...
// Componente de Zoom para Câmera Real (mantido igual)
...
// Componente AlertPopups (mantido igual)
